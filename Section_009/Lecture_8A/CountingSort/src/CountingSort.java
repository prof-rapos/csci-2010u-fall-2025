public class CountingSort {
  ...
  public static void countingSort(int[] arr, int maxValue) {
    ...
    // Step 4: Copy sorted array back to original array (hint: System.arracopy(src, ind, targ, ind, len)
    System.arraycopy(sorted,0,arr,0,arr.length);
  }

  // Test method
  public static void main(String[] args) {
    int[] arr = {0, Integer.MAX_VALUE/3};
    int maxValue = Integer.MAX_VALUE/3;
